...
/// <summary>
/// Record describing the state of an recipe exported to the search index
/// </summary>
[Index(nameof(RecipeBookFk))]
[Index(nameof(RecipeFk), IsUnique = true)]
...
public class RecipeExternalSearchIndexStateDbObject
{
    /// <summary>
    /// Primary key
    /// </summary>
