...
/// <summary>
/// Database result holding 4 types
/// </summary>
...
public class DatabaseResultVariant<TValue1, TValue2, TValue3, TValue4> : IDatabaseResult
    ...
    where TValue4 : IDatabaseResult
{
    ...
    public static implicit operator DatabaseResultVariant<TValue1, TValue2, TValue3, TValue4>(
        TValue1 value1
    ) => new(value1);
